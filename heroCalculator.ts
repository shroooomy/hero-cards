...
function getHeroInfo(): { name: string; strength: number; speed: number } {
    console.log("🦸‍♂️ Welcome to the Hero Power Level Calculator! 🦸‍♂️");
    
    // Step 1: Get the hero's name
    let heroName: string | null;
    while (true) {
...
function runHeroCalculator(): void {
    try {
...
export { calculatePowerLevel, getNumberInput, getHeroInfo, runHeroCalculator };
